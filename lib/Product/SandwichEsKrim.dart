...
class SandwichEsKrim extends StatefulWidget {
  @override
  _SandwichEsKrimState createState() => _SandwichEsKrimState();
}

class _SandwichEsKrimState extends State<SandwichEsKrim> {
  bool isLiked = false;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              const Text(
                'Sandwich Es krim terdiri es krim ditengah-tengah dan dilapisi roti.',
              ...
              Column(
                ...
                children: [
                  _buildvariasiItem('- Sandwich Es Krim Oreo'),
                  _buildvariasiItem('- Sandwich Es Krim Matcha'),
                  _buildvariasiItem('- Sandwich Es Krim Karamel'),
                ],
              ),
              const SizedBox(height: 20),
            ],
