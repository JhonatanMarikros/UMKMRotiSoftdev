...
class SandwichStrawberry extends StatefulWidget {
  @override
  _SandwichStrawberryState createState() => _SandwichStrawberryState();
}

class _SandwichStrawberryState extends State<SandwichStrawberry> {
  bool isLiked = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sandwich Strawberry'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              const Text(
                'Sandwich stroberi klasik adalah hidangan manis yang terdiri dari roti tawar lembut yang diisi dengan irisan stroberi segar dan krim kocok manis.',
              ...
              Column(
                ...
                children: [
                  _buildvariasiItem('- Sandwich Stroberi dengan Keju Krim'),
                  _buildvariasiItem('- Sandwich Stroberi dengan Yogurt'),
                  _buildvariasiItem('- Sandwich Stroberi dengan Mint'),
                ],
              ),
              const SizedBox(height: 20),
            ],
